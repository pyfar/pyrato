...
def subtract_noise_from_squared_rir(data):
    ...
    """
    noise_level = estimate_noise_energy(data, is_energy=True)
...
def intersection_time_lundeby(
    data, sampling_rate, freq='broadband', is_energy=False, time_shift=False,
