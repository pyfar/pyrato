...
def test_preprocessing_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/preprocessing_1D.csv', delimiter=',')[np.newaxis]
...
def test_preprocessing_time_shift_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/preprocessing_time_shift_1D.csv', delimiter=',')[np.newaxis]
...
def test_preprocessing_time_shift_channel_independent_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/preprocessing_time_shift_channel_independent_1D.csv', delimiter=',')[np.newaxis]
...
def test_smoothed_rir_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/smoothed_rir_1D.csv', delimiter=',')[np.newaxis]
...
def test_edc_truncation_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/edc_truncation_1D.csv', delimiter=',')[np.newaxis]
...
def test_edc_lundeby_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/edc_lundeby_1D.csv', delimiter=',')[np.newaxis]
...
def test_edc_lundeby_chu_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/edc_lundeby_chu_1D.csv', delimiter=',')[np.newaxis]
...
def test_edc_chu_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/edc_chu_1D.csv', delimiter=',')[np.newaxis]
...
def test_intersection_time_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/intersection_time_1D.csv', delimiter=',')[np.newaxis].T
...
def test_noise_energy_from_edc_1D():
    rir = genfromtxt('../test_data/analytic_rir_psnr50_1D.csv', delimiter=',')
    expected = genfromtxt('../test_data/noise_energy_from_edc_1D.csv', delimiter=',')[np.newaxis]
